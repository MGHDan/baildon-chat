  ...
  return (
    <div className="flex flex-col h-screen max-w-2xl mx-auto">
      ...
      <header className="bg-school-teal text-white px-4 py-4 flex items-center gap-3 shadow-md flex-shrink-0">
        ...
        <div>
          <h1 className="font-bold text-lg leading-tight">Baildon CE Primary</h1>
          <p className="text-sm text-teal-100">Parent Assistant — ask me anything</p>
        </div>
      </header>
            ...
            <div className="flex gap-3">
              ...
              <div className="bg-white rounded-2xl rounded-tl-sm px-4 py-3 shadow-sm max-w-sm">
                <p className="text-gray-700 text-sm">
                  Hi! I&apos;m the Baildon CE Primary parent assistant. I can help you find information from school
